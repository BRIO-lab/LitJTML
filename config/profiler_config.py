...
class Configuration:
    def __init__(self):
        self.init = {
            ...
            'FAST_DEV_RUN': False,  # Runs inputted batches (True means 1) and disables logging and some callbacks
            'MAX_EPOCHS': 1,
            'MAX_STEPS': 40,    # -1 means it will do all steps and be limited by epochs
